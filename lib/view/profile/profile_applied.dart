...
class ProfileApplied extends StatefulWidget {
  const ProfileApplied({Key? key}) : super(key: key);

  @override
  State<ProfileApplied> createState() => _ProfileAppliedState();
}

class _ProfileAppliedState extends State<ProfileApplied> {
  @override
  void initState() {
    __data();
    super.initState();
