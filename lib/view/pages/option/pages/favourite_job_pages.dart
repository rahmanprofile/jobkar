...
class FavouriteJobList extends StatefulWidget {
  const FavouriteJobList({Key? key}) : super(key: key);

  @override
  State<FavouriteJobList> createState() => _FavouriteJobListState();
}

class _FavouriteJobListState extends State<FavouriteJobList> {
  @override
  void initState() {
    data();
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Favourite Job", style: GoogleFonts.roboto(fontSize: 23,color: Colors.black)),
      ),
      body: Padding(
