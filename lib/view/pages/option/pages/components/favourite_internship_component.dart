...
class FavouriteInternshipComponent extends StatelessWidget {
  final String id;
  final String salary;
  ...
  const FavouriteInternshipComponent({
    Key? key,
    required this.id,
                  ...
                  children: [
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text("Apply",style: GoogleFonts.roboto(fontSize: 12,fontWeight: FontWeight.w300),),
                        ),
                      ),
                    ),
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text("Apply with Premium",style: GoogleFonts.roboto(fontSize: 12,fontWeight: FontWeight.w300,color: Colors.white),),
                        ),
                      ),
                    ),
                    const Spacer(),
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child:const Center(
                          child: Icon(CupertinoIcons.delete,size: 15,color: Colors.red),
                        ),
                      ),
                    ),
                  ],
