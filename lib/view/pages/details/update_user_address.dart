...
class UpdateUserAddress extends StatefulWidget {
  const UpdateUserAddress({Key? key}) : super(key: key);

  @override
  State<UpdateUserAddress> createState() => _UpdateUserAddressState();
}

class _UpdateUserAddressState extends State<UpdateUserAddress> {
            ...
            child: Column(
              ...
              children: [
                ...
                _textCard("Area", "Enter your area name",
                  ...
                  Provider.of<UpdateController>(context, listen: false).updateArea(context, areaController.text);
                  areaController.clear();
                    }),
                const SizedBox(height: 10),
                _textCard("City", "What your good city", LineAwesomeIcons.city,
                    cityController, () {
                      Provider.of<UpdateController>(context, listen: false).updateCity(context, cityController.text);
                      cityController.clear();
                    }),
                const SizedBox(height: 10),
                _textCard("District", "Which district you belong",
                    LineAwesomeIcons.building, districtController, () {
                      Provider.of<UpdateController>(context, listen: false).updateDistrict(context, districtController.text);
                      districtController.clear();
                    }),
                const SizedBox(height: 10),
                _textCard("State", "Whats your country state",
                    LineAwesomeIcons.map, stateController, () {
                      Provider.of<UpdateController>(context, listen: false).updateState(context, stateController.text);
                      stateController.clear();
                    }),
                const SizedBox(height: 10),
                _textCard("Zipcode", "What your zipcode",
                    LineAwesomeIcons.code_branch, zipController, () {
                      Provider.of<UpdateController>(context, listen: false).updateZip(context, zipController.text);
                      zipController.clear();
                    }),
              ],
            ),
